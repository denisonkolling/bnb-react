export const myStays = [
	{
		...
		endDate: new Date('2029-03-21T00:00:00.000Z'),
		...
		recommended: true,
		maxGuests: 5,
		locationDescription: 'Amalfi, Itália',
		reservations: [
			{
				id: 12,
				stayId: 12,
	...
	},
	{
		...
		recommended: true,
		maxGuests: 5,
		locationDescription: 'New York, Estados Unidos',
		reservations: [
			{
				id: 12,
				stayId: 13,
...

	{
		...
		recommended: true,
		maxGuests: 5,
		locationDescription: 'Florença, Itália',
		reservations: [
			{
				id: 12,
				stayId: 13,
...

	{
		...
		startDate: new Date('2024-05-21T00:00:00.000Z'),
		endDate: new Date('2029-05-29T00:00:00.000Z'),
		...
		recommended: true,
		maxGuests: 5,
		locationDescription: 'Lago Sereno, Suíça',
		reservations: [],
	},
	{
		id: 5,
		...
		recommended: false,
		maxGuests: 5,
		locationDescription: 'Madrid, Espanha',
		reservations: [],
	},
	{
		id: 6,
		...
		recommended: false,
		maxGuests: 5,
		locationDescription: 'Montreal, Canadá',
		reservations: [],
	},
	{
		id: 7,
		...
		imagesUrl: [
			...
			'https://images.unsplash.com/photo-1596394516093-501ba68a0ba6?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80',
			'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?ixlib=rb-4.0.3&ixid=M3wxMA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80',
		],
		pricePerDay: 300,
		highlights: [
			'Café da manhã incluso',
		...
		recommended: false,
		maxGuests: 5,
		locationDescription: 'Oslo, Noruega',
		reservations: [],
	},
	{
		id: 8,
		...
		recommended: false,
		maxGuests: 5,
		locationDescription: 'Amsterdam, Holanda',
		reservations: [],
	},
	{
		id: 9,
		...
		recommended: false,
		maxGuests: 5,
		locationDescription: 'Paris, França',
		reservations: [],
	},
];
