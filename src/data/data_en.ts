export const StaysData = [
	{
		name: 'Hotel Aurora',
		description:
			'Hotel Aurora is a charming retreat set amidst the majestic mountains. With its lush gardens and elegant architecture, Aurora offers spacious, beautifully decorated rooms, award-winning cuisine, a luxurious spa and a range of leisure facilities. Its the perfect place for travelers seeking a relaxing and rejuvenating getaway, providing a memorable experience in a stunning setting.',
		startDate: new Date('2023-07-03T22:00:00.000Z'),
		endDate: new Date('2023-07-30T22:00:00.000Z'),
		...
		imagesUrl: [
			...
			'https://images.unsplash.com/photo-1534612899740-55c821a90129?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=8 0',
		],
		pricePerDay: 250,
		highlights: [
			'Breakfast included',
	...
	},
	{
		...
		imagesUrl: [
			'https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=8 0',
			'https://images.unsplash.com/photo-1584132967334-10e028bd69f7?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=8 0',
	...
	},
	{
		...
		description:
			'Azure Haven Retreat is a luxurious oasis located on a private island where the watersThe crystal clear ocean meets pristine white sand beaches. With contemporary and elegant architecture, this exclusive hotel offers its guests a peaceful and sophisticated getaway experience. Spacious, meticulously decorated rooms and suites provide a serene environment, while world-class restaurants offer exquisite cuisine featuring fresh ingredients and international flavors. In addition, Azure Haven Retreat offers a variety of leisure activities such as diving, yachting and relaxation in a luxury spa, ensuring an unforgettable experience of seaside luxury.',
		startDate: new Date('2023-07-03T22:00:00.000Z'),
		endDate: new Date('2023-07-30T22:00:00.000Z'),
		location: 'Lago Sereno, Switzerland',
		countryCode: 'CH',
		coverImage:
			'https://images.unsplash.com/photo-1568084680786-a84f91d1153c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1374&q=8 0',
		imagesUrl: [
			'https://images.unsplash.com/photo-1611892440504-42a792e24d32?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=8 0',
			'https://images.unsplash.com/photo-1528215747454-3d0e0902fff2?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1332&q=80 ',
			'https://images.unsplash.com/photo-1455587734955-081b22074882?ixlib=rb-4.0.3&ixid=M3wxMA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80',
		],
		pricePerDay: 600,
	...
	},
	{
		name: 'Palazzo Sereno',
		description:
			'Palazzo Sereno is a luxury hotel located in a historic European city. With stunning architecture and an elegant ambiance, the hotel offers guests an exclusive experience of comfort and sophistication. The exquisitely decorated rooms provide a peaceful retreat, while the high-quality services guarantee an unforgettable stay. With a privileged location, Palazzo Sereno allows guests to explore the citys beauty and experience local culture with ease. A stay at this hotel is a true experience of luxury and refinement.',
		startDate: new Date('2023-07-03T22:00:00.000Z'),
		endDate: new Date('2023-07-30T22:00:00.000Z'),
	...
	},
	{
		...
		description:
			'Mountain Haven Retreat is a luxury boutique hotel located in a serene mountain region, surrounded by stunning scenery and tranquility. With elegantly decorated rooms, the hotel offers guests a comfortable and relaxing stay amidst untouched nature. Guests can enjoy gourmet meals prepared with fresh, local ingredients at the hotels restaurant, whilst taking in stunning mountain views. With access to hiking trails, outdoor activities and a relaxing spa, Mountain Haven Retreat provides guests with a luxurious experience in a charming, natural getaway.',
		startDate: new Date('2023-07-03T22:00:00.000Z'),
		endDate: new Date('2023-07-30T22:00:00.000Z'),
	...
	},
	{
		...
		countryCode: 'NO',
		coverImage:
			'https://images.unsplash.com/photo-1610530531783-56a4e92a3305?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=8 0',
		imagesUrl: [
	...
	},
	{
		...
		imagesUrl: [
			...
			'https://images.unsplash.com/photo-1512237798647-84b57b22b517?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=8 0',
